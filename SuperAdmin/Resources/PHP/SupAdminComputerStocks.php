<?php
    ...
    try {
        ...
        //computer
        $getComputer = $conn->prepare("SELECT * FROM tbl_stocks INNER JOIN tbl_computerspecs ON tbl_stocks.serial_NO=tbl_computerspecs.serial_NO WHERE WhatType='Computer' and stock_STATUS = 'NEW'");
        $getComputer->execute();
