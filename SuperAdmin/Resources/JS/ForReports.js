$(document).ready(function() {
            ...
            $.post("../SuperAdmin/Resources/PHP/SupAdminReportsViewComp.php",
            ...
            $(".comp_auditreels").find(".View").click(function () {
                ...
                var prop=JSON.stringify(
                  ...
                  $.post("../SuperAdmin/Resources/PHP/SupAdminViewAudit.php",prop,
                  function(data, status){
                  var data=$.parseJSON(data);    
                  var row="";
                  for(var i=0;i<data.length;i++){
...
// Printer////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $.post("../SuperAdmin/Resources/PHP/SupAdminReportsViewPrinter.php",
        function(data, status){
        var data=$.parseJSON(data);    
        var row="";
        for(var i=0;i<data.length;i++){
    ...
    $.post("../SuperAdmin/Resources/PHP/SupAdminReportsViewOther.php",
    function(data, status){
    var data=$.parseJSON(data);    
    var row="";
    for(var i=0;i<data.length;i++){
