        ...
        <a href="../SuperAdmin"> <img src="logo.png" class="rounded-circle" width="50" height="50"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active rounded-pill link-dark" style="background-color: aliceblue;" href="PMDone.php">PM Forms</a>
                </li>
                ...
                <span class="visually-hidden">unread messages</span>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <!-- <li><a class="dropdown-item" href="PMDone.php"><i class="bi bi-ticket"></i>&nbsp;PM Forms</a></li> -->
                        <li>
...
<div class="modal fade" id="try" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <button type="button" class="btn btn-success" id="acceptPM">Approve PM</button>
                <input type="button" class="btn btn-primary" id="prt" onclick="printDiv5('printThis5')" value="Print">
