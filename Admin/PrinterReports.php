...
<html lang="en">
  <head>
   ...
   <script src="https://cdn.datatables.net/buttons/2.3.6/js/dataTables.buttons.min.js"></script>
    ...
    <title>IHOMS AMS | Printer Reports</title>
  </head>
  <body>
             ...
             <span class="visually-hidden">unread messages</span>
              ...
              <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="ComputerReports.php" role="button" aria-expanded="false">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="#"><i class="bi bi-printer"></i></i>&nbsp;Printer Records</a></li>
    ...
    <div class="modal fade bd-example-modal-lg" id="view" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-body">
                    ...
                    <table id="printer_auditsreports" class="table table-hover" style="100%;">
                        <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>User</th>
        ...
        <div class="card-body">
            ...
            <table id="printer_report" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                    <th>Deparment</th>
                    <th>User</th>
