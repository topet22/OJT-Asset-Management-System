...
<html lang="en">
  <head>
    ...
    <script src="Resources/JS/JobOrder2.js"></script>
      ...
      <a href="../User"> <img src="../logo.png" class="rounded-circle" width="50" height="50"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link" href="../MCC">Dashboard</a>
            </li>
            <li class="nav-item">
              ...
              <div class="text-center">
                  ...
                  <div class="container">
                    ...
                    <div class="form-group">
                        <div class="col-xs">
                            <select class="SelectJO form-control mb-2" id="JO_Type" style="width:25%;">
                    ...
                    <div class="row">
                        <div class="input-group mb-3">
                          ...
                          <div class="col-xs">
                            <select class="JO_Desti form-control mb-2" id="JO_Desti">
          ...
          <div class="table-responsive-md">
            <table class="table table-border border-dark">
              ...
              <tbody>
                <tr>
                  <td>
                      <Input type="text" id="JO_Serial" class="form-control" value="NA" disabled>
                  ...
                  <td>
                    <input type="text" class="form-control" id="JO_Quantity" placeholder="Quantity" value="NA" disabled>
