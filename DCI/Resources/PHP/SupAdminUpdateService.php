<?php
    ...
    foreach($JOS as $JO)
    {
        ...
        $sql2 = "SELECT * FROM tbl_jostat where JO_TicketNum='". $joticketnum ."' AND JO_AcceptedBy = '". $_SESSION['DCfull_name']."'";
        ...
        if ($row > 0)
        {
            $sql = "UPDATE tbl_jostat set JO_Status='HOMIS:FOR APPROVAL', JO_DATESRDone = '".$today."',JO_DATESRDone1 = '".$today1."',JO_ActionTaken = '". $action ."', JO_Assessment = '". $assesment ."', JO_Recommendation = '". $recommendation ."', JO_PerfBy = '".$_SESSION['DCfull_name']."' where JO_TicketNum='". $joticketnum ."'";
            $conn->exec($sql);
        
            $action = "Generated Service Report for Job Order No:" . $joticketnum;
            $sql3 = "INSERT INTO audit_r3 (audit_USER, audit_ACTION, audit_PROPNO) VALUES ('". $_SESSION['DCuser_name'] ."','". $action ."','".$PropertyNo."')"; 
            $conn->exec($sql3);  
