...
<html lang="en">
  <head>
    ...
    <title>IHOMS AMS | Computer Reports</title>
  </head>
  <body>
    ...
    <!----------------------------------Modal View Reports-------------------------------->
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-body">
                    ...
                    <table id="computer_auditsreports" class="table table-hover" style="100%;">
                        <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>User</th>
        ...
        <div class="card-body">
            ...
            <table id="computer_report" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                    <th>Deparment</th>
                    <th>User</th>
