<?php
    ...
    try {
        ...
        foreach ($computers as $computer) {
            array_push($data,
                array("comp_ID"=>$computer["comp_id"],"InvUser"=>$computer["user"],"InvDept"=>$computer["department"],"InvPropNo"=>$computer["property_NO"] ,"InvSerial"=>$computer["serial_NO"] ,"InvDate"=>$computer["date_acquired"],
