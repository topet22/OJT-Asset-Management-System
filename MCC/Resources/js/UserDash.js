$(document).ready(function() {
            ...
            $.post("../MCC/Resources/php/UserGetNum.php",
            ...
            $.post("../MCC/Resources/php/UserGetPM.php",
            function(data, status){
            var data=$.parseJSON(data);    
            var row="";
            for(var i=0;i<data.length;i++){
    ...
    //////////////////////////////////////////////////////////////////
            $.post("../MCC/Resources/php/UserComputers.php",
            function(data, status){
            var data=$.parseJSON(data);    
            var row="";
            ...
            for(var i=0;i<data.length;i++){
                ...
                {
                    row=row+"<tr><td>"+data[i].InvUser+"</td><td>"+data[i].InvPropNo+"</td><td>"
                    +data[i].InvSerial+"</td><td>"+data[i].InvModel+"</td><td>"+data[i].InvBrand+"</td><td>"+data[i].CompType+"</td><td>"+data[i].CompOS+"</td><td>"+data[i].InvDate+"</td><td><span class ='badge rounded-pill bg-warning'>"
                    +data[i].InvStatus+"</span></td><td>"+data[i].Reason+"</td></tr>";
                }
                else
                {
            ...
            $.post("../MCC/Resources/php/UserPrinters.php",
            function(data, status){
            var data=$.parseJSON(data);    
            var row="";
            ...
            $.post("../MCC/Resources/php/UserOthers.php",
            function(data, status){
            var data=$.parseJSON(data);  
    ...
    $("#save_pass").on('click', function () {
        ...
        if(OldPass!="" && NewPass!="" && ConPass!="")
        {
            ...
            $.post("../MCC/Resources/php/ChangePassword.php",
            JSON.stringify({
                OldPass :OldPass,
                NewPass:NewPass,
                ConPass:ConPass
    ...
    $("#savesignature").on('click', function () {
        ...
        var sigdataUrl=$("#sigdataUrl").get(0).value;
            ...
            $.post("../MCC/Resources/php/updatesignature.php",
            JSON.stringify({
