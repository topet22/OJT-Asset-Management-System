    ...
    try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            ...
            foreach ($JO as $JO) {
                ...
                "JO_Status"=>$JO["JO_Status"],"JO_PropertyNO"=>$JO["JO_PropertyNO"],"JO_Model"=>$JO["JO_Model"],"JO_PerfBy"=>$JO['JO_PerfBy'],"JO_DesigUser"=>$JO['JO_DesigUser'],"JO_DATESRDone1"=>$JO["JO_DATESRDone1"]
