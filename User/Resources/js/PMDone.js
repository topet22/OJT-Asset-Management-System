$(document).ready(function() {
    ...
    $.post("../User/Resources/PHP/PMDone.php",
    ...
    $(".jo_act").find(".View").click(function () {
        ...
        var prop=JSON.stringify(
           ...
           $.post("../User/Resources/PHP/PMDets.php",prop,
           function(data, status){
            var data=$.parseJSON(data);    
            var row="";
            for(var i=0;i<data.length;i++){
          ...
          $.post("../User/Resources/PHP/viewpmsignature.php",prop,
          function(data, status){
            var data=$.parseJSON(data); 
...
$("#verify").on('click', function () {
    ...
    var prop=JSON.stringify(
      ...
      $.post("../User/Resources/PHP/verifyPM.php",prop,
      function(data, status){
          if(data == 1) 
          { 
              alert("PM Verified!");
