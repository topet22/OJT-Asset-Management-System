...
<!------------------------------------------------------------------------------------------>
        ...
        <div class="card" style="background-color:rgb(237, 238, 240);" width="100%">
         ...
         <div class="card-body">
          <table id="tblarch_computers" class="table table-striped" style="width:100%">
            <center><h4>Computer Table</h4></center>
              <thead>
                      <tr>
                          <th>Item ID</th>
                          <th>Property No</th>
      ...
      <div class="container w-auto pt-3" id ="prt_tblarch">
        <div class="card" style="background-color:rgb(237, 238, 240);" width="100%">
         ...
         <div class="card-body">
          <table id="tbl_printersarch" class="table table-striped" style="width:100%">
             <center><h4>Printer Table</h4></center>
              <thead>
                      <tr>
                          <th>Item ID</th>
                          <th>Property No</th>
      ...
      <div class="container w-auto pt-3" id ="oth_tblarch">
        <div class="card" style="background-color:rgb(237, 238, 240);" width="100%">
         ...
         <div class="card-body">
          <table id="tbl_othersarch" class="table table-striped" style="width:100%">
             <center><h4>Others Table</h4></center>
              <thead>
                      <tr>
                          <th>Item ID</th>
                          <th>Property No</th>
