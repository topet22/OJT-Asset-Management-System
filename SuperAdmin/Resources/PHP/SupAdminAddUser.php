...
<?php
    ...
    $sql = "INSERT INTO tbl_users (department, username, user_fullname ,pass, userlevel)
    VALUES ('". $UserDepartment ."','". $AddUsername ."','".$AddFullName."','". $AddPassword ."','". $AddUserLevel ."')";
    $conn->exec($sql);
    echo "1";
