...
<?php
    ...
    if($InvenStatus == "Condemned"){
        $InvenStatus = "Pending Condemn";
    }
    ...
    if($statusTYPEs == "Computer")
    {
        ...
        VALUES ('". $_SESSION['Auser_name'] ."','". $CompProp ."','". $action ."')"; 
        $conn->exec($sql2);
    ...
    elseif($statusTYPEs == "Printer")
    {
        ...
        $sql2 = "INSERT INTO audit_r3 (audit_USER, audit_PROPNO	 ,audit_ACTION)
        VALUES ('". $_SESSION['Auser_name'] ."','". $PrintProp ."','". $action ."')"; 
        $conn->exec($sql2);
    ...
    else
    {
        ...
        $sql2 = "INSERT INTO audit_r3 (audit_USER, audit_PROPNO	 ,audit_ACTION)
        VALUES ('". $_SESSION['Auser_name'] ."','". $OtherProp ."','". $action ."')"; 
        $conn->exec($sql2);
